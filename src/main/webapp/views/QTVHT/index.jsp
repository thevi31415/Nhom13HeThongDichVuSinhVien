...
%>
<div class ='content'>
  <a href="<%=request.getContextPath()%>/views/QTVHT/guithongbao.jsp" class="add-user-button">Gửi thông báo</a>
<h2>Thông báo đã nhận</h2>
   <table class="notification-table">
        ...
        <tbody>
            ...
            %>
                <tr>
                    <td class="notification-title"><a href="xemnoidungQTVHT?ndid=<%= MaThongBao %>"><%= thongbao.getTieuDe() %></a></td>
