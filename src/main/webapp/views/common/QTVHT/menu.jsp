  ...
  .Info {
    ...
    color: white;
         ...
         <li><a href="">
          ...
          <li><a href="<%=request.getContextPath()%>/views/QTVHT/index.jsp"<% if (request.getRequestURI().endsWith("/index.jsp")) { %>class="active"<% } %>>
        ...
        <li><a href="<%=request.getContextPath()%>/views/QTVHT/quanlytaikhoan.jsp" <% if (request.getRequestURI().endsWith("/quanlytaikhoan.jsp")) { %>class="active"<% } %>>
          <span class="icon"><i class="fas fa-file-video"></i></span>
          <span class="title">Quản lý tài khoản</span>
          </a></li>
        <li><a href="<%=request.getContextPath()%>/views/QTVHT/quanlysinhvien.jsp" <% if (request.getRequestURI().endsWith("/quanlysinhvien.jsp")) { %>class="active"<% } %> >
          <span class="icon"><i class="fas fa-volleyball-ball"></i></span>
          <span class="title">Quản lý sinh viên</span>
          </a></li>
             <li><a href="<%=request.getContextPath()%>/views/QTVHT/thongkeyeucau"<% if (request.getRequestURI().endsWith("/thongke.jsp")) { %>class="active"<% } %>>
          <span class="icon"><i class="fas fa-leaf"></i></span>
          <span class="title">Thống kê yêu cầu</span>
          </a></li>
        <li><a href="<%=request.getContextPath()%>/views/QTVHT/phanhoi.jsp"<% if (request.getRequestURI().endsWith("/phanhoi.jsp")) { %>class="active"<% } %>>
          <span class="icon"><i class="fas fa-leaf"></i></span>
