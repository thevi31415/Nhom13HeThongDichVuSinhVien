...
%>
<div class ='content'>
 <form action="<%=request.getContextPath()%>/views/CTSV/phanhoi" method="post">
 	<fieldset id="headField">
 		<legend>Phản hồi người dùng mã:</legend>
 		<textarea id="txtPhanHoiMaND" name="txtPhanHoiMaND"></textarea>
 		<legend>Phản hồi yêu cầu mã:</legend>
 		<textarea id="txtPhanHoiMaYC" name="txtPhanHoiMaYC"></textarea>
 		<legend>Tiêu đề</legend>
 		<textarea id="txtTieuDePH" name="txtTieuDePH" ></textarea>
 	</fieldset>
 	<fieldset id="contentField">
 		<legend>Nội dung</legend>
 		<textarea id="txtNoiDungPH" name="txtNoiDungPH"></textarea>
 	</fieldset>
