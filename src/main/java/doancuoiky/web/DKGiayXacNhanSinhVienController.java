	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (success) {
                ...
                response.getWriter().write("<script>alert('" + successMessage + "'); setTimeout(function(){ window.location.href='/DoAnCuoiKyDVSV_Nhom13_FINAL_2/views/SV/dangkygiayxacnhan.jsp'; }, 0);</script>");
            } else {
                // Thông báo thất bại và chuyển hướng trang sau 2 giây
                String failureMessage = "Đăng ký thất bại";
                response.getWriter().write("<script>alert('" + failureMessage + "'); setTimeout(function(){ window.location.href='/DoAnCuoiKyDVSV_Nhom13/views/SV/dangkygiayxacnhan.jsp'; }, 0);</script>");
                response.sendRedirect("/DoAnCuoiKyDVSV_Nhom13_FINAL_2/views/SV/dangkygiayxacnhan.jsp");
            }
