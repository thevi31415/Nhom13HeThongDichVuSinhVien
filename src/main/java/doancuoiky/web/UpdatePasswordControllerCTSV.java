...
/**
 * Servlet implementation class UpdatePasswordControllerCTSV
 */
@WebServlet("/views/CTSV/doimatkhau")
public class UpdatePasswordControllerCTSV extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdatePasswordControllerCTSV() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
			...
			if(succ) {
                ...
                request.getRequestDispatcher("/views/CTSV/doimatkhau.jsp").forward(request, response);
