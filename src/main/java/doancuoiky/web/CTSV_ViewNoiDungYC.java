 ...
 */
@WebServlet("/views/CTSV/viewnoidungyc")
public class CTSV_ViewNoiDungYC extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CTSV_ViewNoiDungYC() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            request.getRequestDispatcher("/views/CTSV/phanhoi.jsp").forward(request, response);
