...
/**
 * Servlet implementation class UpdatePasswordControllerQTVHT
 */
@WebServlet("/views/QTVHT/doimatkhau")
public class UpdatePasswordControllerQTVHT extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdatePasswordControllerQTVHT() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       try {
			...
			if(succ) {
                 ...
                 request.getRequestDispatcher("/views/QTVHT/doimatkhau.jsp").forward(request, response);
